...
create_square_image('uploads/'.$path['file_name'],'uploads/'.$path['file_name'],240);   
	      ...
	      $g['photo']="../uploads/default_gift.jpg";	
	    	$this->db->insert('gift',$g);
	    	//square image create
       ...
       function edit() 
       {
	    ...
	    $path=$this->upload->data();
	    $query2=$this->db->get_where('gift',array('id'=>$giftId));
...
create_square_image('uploads/'.$path['file_name'],'uploads/'.$path['file_name'],240);
	    ...
	    if ($path['file_name'] != "")
	      ...
	      $g['photo']="../uploads/default_gift.jpg";	
	       $this->db->update('gift',$g,array('id'=> $giftId));
       }
    }
